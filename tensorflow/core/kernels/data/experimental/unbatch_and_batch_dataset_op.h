...
==============================================================================*/
#ifndef TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_UNBATCH_AND_BATCH_DATASET_OP_H_
#define TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_UNBATCH_AND_BATCH_DATASET_OP_H_
...
class UnbatchAndBatchDatasetOp : public UnaryDatasetOpKernel {
 public:
  static constexpr const char* const kDatasetType = "UnbatchAndBatch";
...
#endif  // TENSORFLOW_CORE_KERNELS_DATA_EXPERIMENTAL_UNBATCH_AND_BATCH_DATASET_OP_H_
